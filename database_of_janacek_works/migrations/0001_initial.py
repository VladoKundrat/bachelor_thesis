...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('interpret', models.ForeignKey(to='database_of_janacek_works.Interpret')),
            ],
        ),
        migrations.CreateModel(
            name='Piece',
        ...
        migrations.AddField(
            ...
            name='piece',
            field=models.ManyToManyField(to='database_of_janacek_works.Piece', through='database_of_janacek_works.InterpretPiece'),
        ),
        migrations.AddField(
            model_name='composer',
            name='album',
