...
class PieceListJson(BaseDatatableView):
       ...
       columns = ['piece_id', 'cz_title', 'en_title', 'jw_catalogue_number', 'time_of_composition', 'date_of_premiere', 'place_of_premiere', 'compose_for', 'number_of_movement', 'wiki']

       #define column names that will be used in sorting
       order_columns = ['piece_id', 'cz_title', 'en_title', 'jw_catalogue_number', 'time_of_composition', 'date_of_premiere', 'place_of_premiere', 'compose_for', 'number_of_movement', 'wiki']
...
class AlbumListJson(BaseDatatableView):
    ...
    columns = ['album_id', 'label_name', 'catalogue_number', 'album_name', 'album_published_year', 'published_country', 'number_of_media', 'recording_technology', 'diameter', 'rpm', 'region_code', 'side_coumpling', 'tv_system', 'sound_system', 'medium_type', 'subtitles', 'comment', 'text_language', 'text_by', 'note_language', 'note_by', 'libretto_language', 'libretto_by']

    order_columns = ['album_id', 'label_name', 'catalogue_number', 'album_name', 'album_published_year', 'published_country', 'number_of_media', 'recording_technology', 'diameter', 'rpm', 'region_code', 'side_coumpling', 'tv_system', 'sound_system', 'medium_type', 'subtitles', 'comment', 'text_language', 'text_by', 'note_language', 'note_by', 'libretto_language', 'libretto_by']
